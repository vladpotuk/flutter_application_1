...
abstract class AppColors {
  static const Color gradientTop = Color(0xFF011746);
  static const Color gradientBottom = Color(0xFF017180);

  static const Color backgroundColor = Color(0xFFFFFFFF);
  static const Color buttonBackgroundColor = Color(0xFF181818);
